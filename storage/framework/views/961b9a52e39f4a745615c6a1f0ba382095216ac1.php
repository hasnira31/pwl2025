    ...
    <div class="col-lg-10 col-xl-8 mx-auto">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a class="btn btn-sm btn-warning text-white me-1" href="<?php echo e(route('employees.edit', $employee->id)); ?>">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <?php echo e($employee->formatted_salary); ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <?php echo e($employee->created_at->format('d-m-Y H:i:s')); ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <?php echo e($employee->updated_at->format('d-m-Y H:i:s')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/employees/show.blade.php ENDPATH**/ ?>